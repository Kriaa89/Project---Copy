  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-900 to-purple-900 p-4">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -bottom-1/2 -right-1/2 w-full h-full bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-full animate-slow-spin"></div>
        <div className="absolute -top-1/2 -left-1/2 w-full h-full bg-gradient-to-br from-blue-500/20 to-indigo-500/20 rounded-full animate-slow-spin-reverse"></div>
      </div>
      ...
      <div className="w-full max-w-lg relative">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-indigo-200">Join our fitness community today</p>
        </div>
        ...
        <div className="backdrop-blur-md bg-white/10 rounded-2xl shadow-2xl border border-white/20 p-8 transform hover:translate-y-[-2px] transition-all duration-300">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="firstName" className="block text-sm font-medium text-indigo-100 mb-2">
                  First Name
                </label>
                <div className="relative group">
                  ...
                  />
                  {errors.firstName && (
                    <p className="mt-2 text-sm text-red-300 animate-fade-in">{errors.firstName}</p>
                  )}
                </div>
              </div>

              <div>
                <label htmlFor="lastName" className="block text-sm font-medium text-indigo-100 mb-2">
                  Last Name
                </label>
                <div className="relative group">
                  <input
                  ...
                  />
                  {errors.lastName && (
                    <p className="mt-2 text-sm text-red-300 animate-fade-in">{errors.lastName}</p>
                  )}
                </div>
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 px-4 rounded-xl text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transform transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl disabled:opacity-50 font-medium mt-6"
            >
              {isLoading ? (
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-transparent text-indigo-200">or sign up with</span>
              </div>
            </div>
